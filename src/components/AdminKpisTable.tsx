        ...
        {kpis.map((kpi) => (
          <li key={kpi.id}>
            <Link
              ...
              className={`block px-4 py-4 transition-colors focus-visible:outline-solid focus-visible:outline-[3px] focus-visible:-outline-offset-2 focus-visible:outline-(--color-focus) ${selectedKpiId === kpi.id ? "bg-brand-50" : "hover:bg-ink-50"}`}
            >
